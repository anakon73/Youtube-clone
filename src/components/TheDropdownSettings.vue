...
<template>
  <div ref="el" class="relative">
    ...
    <Transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95"
      ...
      <div ref="dropDown" tabindex="-1" @keydown.esc="close" v-show="isOpen" :class="dropdownClasses">
        <component :is="menu" :selectedOptions="selectedOptions" @select-option="selectedOption"
